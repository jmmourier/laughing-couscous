 ...
 */
double get_reference_angle_to_target(
...
double get_reference_angle_to_target(pos_info robot_pos, pos_info target_pos) {
    return get_reference_angle_to_target(
        robot_pos.pos_x,
        robot_pos.pos_y,
        target_pos.pos_x,
        target_pos.pos_y);
 ...
 */
double get_angle_to_target(
    const double robot_pos_x,
    const double robot_pos_y,
    const double robot_orientation,
    const double target_pos_x,
    const double target_pos_y) {
    double angle = get_angle_difference(
        robot_orientation,
        get_reference_angle_to_target(robot_pos_x, robot_pos_y, target_pos_x, target_pos_y));
...
double get_angle_difference(
    const double robot_pos_x,
    const double robot_pos_y,
    const double robot_orientation,
    const double target_pos_x,
    const double target_pos_y) {
    return get_angle_difference(
        robot_orientation,
        get_angle_to_target(
            robot_pos_x,
            robot_pos_y,
