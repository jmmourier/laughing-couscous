...
public:
  explicit WebPositionService(std::function<void(double pos_x_m, double pos_y_m,
  ...
  ::grpc::Status setAbsolutePosition(::grpc::ServerContext *context,
...
private:
  const std::function<void(double pos_x_m, double pos_y_m,
                           double orientation_rad)>
